...
#Region "LIMPIAR"
    ...
    Private Sub CargarComboPatente()
        ...
        If oDs.Tables(0).Rows.Count > 0 Then
            cbo_cliente.DataSource = oDs.Tables(0)
            cbo_cliente.ValueMember = oDs.Tables(0).Columns(0).ToString
            cbo_cliente.DisplayMember = oDs.Tables(0).Columns(0).ToString
...
#End Region
    ...
    Private Sub btn_cargar_Click(sender As Object, e As EventArgs) Handles btn_cargar.Click
        ...
        If cbo_cliente.Text <> "" And cbo_filtroaceite.Text <> "" And cbo_filtroaire.Text <> "" And cbo_filtrocombustible.Text <> "" And cbo_lubricante.Text <> "" And cbo_vehiculo.Text <> "" And txt_fecha.Text <> "" And txt_kmini.Text <> "" And txt_proximocambio.Text <> "" And txt_caja.Text <> "" Then
            Dim conexion As SqlConnection
            Dim comando As New SqlCommand
            ...
            With comando.Parameters
                ...
                .AddWithValue("@Cliente", cbo_cliente.Text)
            ...
            MsgBox("El Cambio De Aceite  a " & cbo_cliente.Text & "' Se Registro CORECTAMENTE", vbInformation, "GULF")
    ...
    Private Sub btn_modificar_Click(sender As Object, e As EventArgs) Handles btn_modificar.Click
        If txt_idcambio.Text <> "" And cbo_cliente.Text <> "" And cbo_filtroaceite.Text <> "" And cbo_filtroaire.Text <> "" And cbo_filtrocombustible.Text <> "" And cbo_lubricante.Text <> "" And cbo_vehiculo.Text <> "" And txt_fecha.Text <> "" And txt_kmini.Text <> "" And txt_proximocambio.Text <> "" And txt_caja.Text <> "" Then
            Dim conexion As SqlConnection
            Dim comando As New SqlCommand
            ...
            MsgBox("El Cambio De Aceite a: ' " & cbo_cliente.Text & "' Se Modifico CORECTAMENTE", vbInformation, "GULF")
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        If txt_idcambio.Text <> "" Then
            ...
            MsgBox("El Servicio a ' " & cbo_cliente.Text & "' se ha eliminado correctamente", vbInformation, "GULF")
    ...
    Private Sub btn_consultar_Click(sender As Object, e As EventArgs) Handles btn_consultar.Click
        If txt_idcambio.Text <> "" Then
            ...
            If datoleido.Read = True Then
                cbo_cliente.Text = datoleido("Cliente").ToString
